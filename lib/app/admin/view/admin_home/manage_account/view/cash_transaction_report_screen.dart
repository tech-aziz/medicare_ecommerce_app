...
class CashTransactionReportScreen extends StatefulWidget {
  @override
  _CashTransactionReportScreenState createState() =>
      _CashTransactionReportScreenState();
}

class _CashTransactionReportScreenState
    extends State<CashTransactionReportScreen> {
